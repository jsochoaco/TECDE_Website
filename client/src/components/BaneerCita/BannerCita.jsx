...
const BannerCita = () => {
    ...
    return (
        <div className={style.divContenedorCita}>
            ...
            <iframe  className={style.frame} title="frame" src="https://calendar.google.com/calendar/appointments/schedules/AcZssZ3bu5v4FldFNmPmElQkDE-MeDcQgN7qx-9rms2NlpYxQIXMl1E8FdrT7N-wZphJMVfpU5YPJtVC?gv=true" width="80%" height="max-content" frameborder="0"></iframe>
        </div>
    )
}
