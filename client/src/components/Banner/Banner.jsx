    ...
    return (
        <div className={style.divBanner}>
            <div className={style.divTexto}>
                ...
                <h2 className={style.parrafoBanner1}>{idiomaActual === "es" ? "para la gestión y procesamiento de datos con Inteligencia Artificial":"for data management and processing."}</h2>
