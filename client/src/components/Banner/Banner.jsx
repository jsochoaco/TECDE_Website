    ...
    return (
        <div className={style.divBanner}>
            <div className={style.divTexto}>
                ...
                <h2 className={style.parrafoBanner}>{idiomaActual === "es" ? "Con nuestros servicios podrás impulsar la innovación y la eficiencia en tus operaciones, a través de optimización de procesos, implementación de tecnologías de última generación y desarrollo de soluciones personalizadas":"With our services, you can drive innovation and efficiency in your operations by optimizing processes, implementing state-of-the-art technologies, and crafting tailor-made solutions, all designed to elevate your business"}</h2>
