        ...
        <div className={style.footerContacto}>
            ...
            <div className={style.divRedesTotal}>
                ...
                <div className={style.divRedes}>
                    ...
                    <img className={style.iconoRedes} src="https://api.iconify.design/line-md:linkedin.svg?color=%2300acca" alt="linkedin"/>
                    </NavLink>
                    <NavLink to="https://www.linkedin.com/company/tecde-ingeniería/?viewAsMember=true" className={style.link} target="_blank">    
                ...
                <div className={style.divRedes}>
                    ...
                    <img className={style.iconoRedes} src="https://api.iconify.design/line-md:twitter-x.svg?color=%2300acca" alt="X"/>
                    </NavLink>
                    <NavLink to="https://twitter.com/tecdeing" className={style.link} target="_blank">    
            ...
            <div className={style.divContacto}>
                ...
                <div className={style.divContactData}>
                    ...
                    <img className={style.iconoRedes} src="https://api.iconify.design/ic:baseline-email.svg?color=%2300acca" alt="mail"/>
                    </a>
                    <a href="mailto:ingenieria@tecde.co">
                ...
                <div className={style.divContactData}>
                    <NavLink to="https://api.whatsapp.com/send/?phone=573192956992&text=Hola,%20estoy%20interesado(a)%20en%20saber%20más%20información%20acerca%20de%20TECDE%20Ingeniería%20y%20sus%20servicios%20" className={style.link} target="_blank">
                        <img className={style.iconoRedes} src="https://api.iconify.design/ic:outline-whatsapp.svg?color=%2300acca" alt="mail"/>
                    </NavLink>
                    <NavLink to="https://api.whatsapp.com/send/?phone=573192956992&text=Hola,%20estoy%20interesado(a)%20en%20saber%20más%20información%20acerca%20de%20TECDE%20Ingeniería%20y%20sus%20servicios%20" className={style.link} target="_blank">
                ...
                <div className={style.divContactData}>
                    <a href="tel:+573192956992">
                        <img className={style.iconoRedes} src="https://api.iconify.design/material-symbols:call.svg?color=%2300acca" alt="mail"/>
                    </a>
                    <a href="tel:+573192956992">
                        <h5 className={style.red}>+57 3192956992</h5>
                    </a>
                </div>
            </div>
        </div>
        <div className={style.divMarca}>
            <h5 className={style.marcaTECDE}>tecde 2024</h5>
